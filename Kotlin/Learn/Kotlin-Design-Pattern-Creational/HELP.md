...
* The original package name 'programmer-zaman-now.learn-sping-boot-design-pattern' is invalid and this project uses 'programmerzamannow.learnspingbootdesignpattern' instead.
